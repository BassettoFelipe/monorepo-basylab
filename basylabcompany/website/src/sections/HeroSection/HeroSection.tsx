            ...
            >
              <div className={styles.stat}>
                <span className={styles.statValue}>
                  <CountUp to={10} duration={2} className={styles.countUp} />
                  k+
                </span>
              ...
              <div className={styles.stat}>
                <span className={styles.statValue}>
                  <CountUp to={30} duration={2.5} className={styles.countUp} />+
                </span>
              ...
              <div className={styles.stat}>
                <span className={styles.statValue}>
                  <CountUp to={100} duration={3} className={styles.countUp} />%
                </span>
