...
export function injectTestRepositories(repos: {
  ...
  if (repos.planFeatureRepository)
    repositories.planFeatureRepository = repos.planFeatureRepository;
  ...
  if (repos.customFieldRepository)
    repositories.customFieldRepository = repos.customFieldRepository;
