...
import * as paymentModule from '@/services/payment'
...
// Mock do módulo de payment service usando spyOn
const mockGetPaymentGatewayInstance = spyOn(
	paymentModule,
	'getPaymentGatewayInstance',
).mockReturnValue(mockPaymentGateway)
...
describe('POST /payment/process-card-payment', () => {
	...
	afterAll(() => {
		mockGetPaymentGatewayInstance.mockRestore()
	})
