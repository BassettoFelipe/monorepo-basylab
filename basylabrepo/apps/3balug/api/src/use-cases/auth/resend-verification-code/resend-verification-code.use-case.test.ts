...
const mockEmailService = {
	...
	sendPasswordResetCode: mock(() => Promise.resolve()),
...
describe('ResendVerificationCodeUseCase', () => {
	...
	beforeEach(() => {
		...
		mockSendVerificationCode.mockImplementation(() => Promise.resolve())
	...
	describe('Email Sending', () => {
		...
		test('should rollback database changes if email send fails', async () => {
			...
			mockSendVerificationCode.mockImplementation(() =>
				Promise.reject(new EmailServiceError('SMTP Error', new Error('SMTP connection failed'))),
			)
		...
		test('should throw EmailSendFailedError on email failure', async () => {
			...
			mockUserRepository.update = mock(() => Promise.resolve(user))
			mockSendVerificationCode.mockImplementation(() =>
				Promise.reject(new EmailServiceError('Connection timeout', new Error('Timeout exceeded'))),
			)
		...
		test('should handle generic errors during email send', async () => {
			...
			mockUserRepository.findByEmail = mock(() => Promise.resolve(user))
			mockUserRepository.update = mock(() => Promise.resolve(user))
			mockSendVerificationCode.mockImplementation(() => Promise.reject(new Error('Unknown error')))
	...
	describe('Return Values', () => {
		...
		test('should return decremented remaining attempts', async () => {
			...
			mockUserRepository.findByEmail = mock(() => Promise.resolve(user))
			mockUserRepository.update = mock(() => Promise.resolve(user))
			mockSendVerificationCode.mockImplementation(() => Promise.resolve()) // Ensure email succeeds
