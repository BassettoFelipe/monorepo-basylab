...
import * as imageServiceModule from '@/services/image'
...
const mockGetImageProcessor = spyOn(imageServiceModule, 'getImageProcessor').mockReturnValue(
	mockImageProcessor,
)

// Restore original implementations after all tests
afterAll(() => {
	mockGetImageProcessor.mockRestore()
})
